...
object TextQueryConstants {
  ...
  val COL_NAME6_REMAINPLACE = "RemainPlace" //
  val COL_NAME6_CAPTUREMETHOD = "CaptureMethod" //
  val COL_NAME6_BROKENUSER = "BrokenUser" //
  val COL_NAME6_BROKENUNITCODE = "BrokenUnitCode" //
  val COL_NAME6_ISBROKEN = "IsBroken" //
  val COL_NAME6_HITPERSONSTATE = "HitPersonState" //
  val COL_NAME6_MISCONNECTCASEID = "MISConnectCaseID" //
  val COL_NAME6_CASEOCCURPLACETAIL = "CaseOccurPlaceTail" //
  val COL_NAME6_SUSPICIOUSAREA1CODE = "SuspiciousArea1Code" //
  val COL_NAME6_SUSPICIOUSAREA2CODE = "SuspiciousArea2Code" //
  val COL_NAME6_SUSPICIOUSAREA3CODE = "SuspiciousArea3Code" //
  val COL_NAME6_EXTRACTUNITNAMETAIL = "ExtractUnitNameTail" //
  val COL_NAME6_EXTRACTUNITCODE = "ExtractUnitCode" //
  val COL_NAME6_EXTRACTOR1 = "Extractor1" //
  val COL_NAME6_SUPERVISELEVEL = "SuperviseLevel" //
  val COL_NAME6_CASEOCCURPLACECODE = "CaseOccurPlaceCode" //
  val COL_NAME6_AJID = "AJID" //
  val COL_NAME6_JQID = "JQID" //
  val COL_NAME6_XKID = "XKID" //
  val COL_NAME6_BROKENDATE = "BrokenDate" //
  val COL_NAME6_$$CREATETIME = "$$CreateTime" //
  val COL_NAME6_$$UPDATETIME = "$$UpdateTime" //
  val COL_NAME6_CASEOCCURDATE = "CaseOccurDate" //
