package nirvana.hall.v62.internal.c.gftplib
...
import nirvana.hall.v62.internal.c.ghpcbase.ghpcdef.{AFISDate, AFISDateTime}
import nirvana.hall.v62.internal.c.gloclib.galoclp.{GLPCARDINFOSTRUCT, GCASEINFOSTRUCT}
