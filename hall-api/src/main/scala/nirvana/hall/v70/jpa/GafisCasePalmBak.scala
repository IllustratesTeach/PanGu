...
/**
  ...
  */
object GafisCasePalmBak extends ActiveRecordInstance[GafisCasePalmBak]

@Entity
@Table(name = "GAFIS_CASE_PALM_BAK"
)
class GafisCasePalmBak extends ActiveRecord {
  ...
  def this(gafisCasePalm: GafisCasePalm) {
    this()
    this.palmId = gafisCasePalm.palmId
    this.seqNo = gafisCasePalm.seqNo
    this.caseId = gafisCasePalm.caseId
    this.isCorpse = gafisCasePalm.isCorpse
    this.corpseNo = gafisCasePalm.corpseNo
    this.remainPlace = gafisCasePalm.remainPlace
    this.fgp = gafisCasePalm.fgp
    this.pattern = gafisCasePalm.pattern
    this.ridgeColor = gafisCasePalm.ridgeColor
    this.thanStatus = gafisCasePalm.thanStatus
    this.isAssist = gafisCasePalm.isAssist
    this.palmImg = gafisCasePalm.palmImg
    this.palmCpr = gafisCasePalm.palmCpr
    this.ltCount = gafisCasePalm.ltCount
    this.llCount = gafisCasePalm.llCount
    this.ltCountModMnt = gafisCasePalm.ltCountModMnt
    this.llCountModMnt = gafisCasePalm.llCountModMnt
    this.editCount = gafisCasePalm.editCount
    this.ltDate = gafisCasePalm.ltDate
    this.llDate = gafisCasePalm.llDate
    this.ltOperator = gafisCasePalm.ltOperator
    this.llOperator = gafisCasePalm.llOperator
    this.creatorUnitCode = gafisCasePalm.creatorUnitCode
    this.updatorUnitCode = gafisCasePalm.updatorUnitCode
    this.modifiedtime = gafisCasePalm.modifiedtime
    this.modifiedpsn = gafisCasePalm.modifiedpsn
    this.inputtime = gafisCasePalm.inputtime
    this.inputpsn = gafisCasePalm.inputpsn
    this.deletag = gafisCasePalm.deletag
    this.remark = gafisCasePalm.remark
    this.ltStatus = gafisCasePalm.ltStatus
    this.llStatus = gafisCasePalm.llStatus
    this.sid = gafisCasePalm.sid
    this.matchStatus = gafisCasePalm.matchStatus
    this.developMethod = gafisCasePalm.developMethod
    this.palmImgNosqlId = gafisCasePalm.palmImgNosqlId
    this.palmCprNosqlId = gafisCasePalm.palmCprNosqlId
    this.seq = gafisCasePalm.seq
  }
}