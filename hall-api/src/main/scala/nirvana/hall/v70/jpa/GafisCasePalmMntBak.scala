...
/**
  ...
  */
object GafisCasePalmMntBak extends ActiveRecordInstance[GafisCasePalmMntBak]

@Entity
@Table(name = "GAFIS_CASE_PALM_MNT"
)
class GafisCasePalmMntBak extends ActiveRecord {
  ...
  def this(gafisCasePalmMnt: GafisCasePalmMnt) {
    this()
    this.pkId = gafisCasePalmMnt.pkId
    this.palmId = gafisCasePalmMnt.palmId
    this.captureMethod = gafisCasePalmMnt.captureMethod
    this.palmMnt = gafisCasePalmMnt.palmMnt
    this.palmRidge = gafisCasePalmMnt.palmRidge
    this.isMainMnt = gafisCasePalmMnt.isMainMnt
    this.modifiedtime = gafisCasePalmMnt.modifiedtime
    this.modifiedpsn = gafisCasePalmMnt.modifiedpsn
    this.inputtime = gafisCasePalmMnt.inputtime
    this.inputpsn = gafisCasePalmMnt.inputpsn
    this.palmMntNosqlId = gafisCasePalmMnt.palmMntNosqlId
    this.palmRidgeNosqlId = gafisCasePalmMnt.palmRidgeNosqlId
    this.deletag = gafisCasePalmMnt.deletag
  }
}