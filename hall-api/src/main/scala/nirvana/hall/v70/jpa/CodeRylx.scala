...
/**
 * CodeRylx generated by hall orm 
 */
object CodeRylx extends ActiveRecordInstance[CodeRylx]

@Entity
@Table(name = "CODE_RYLX"
)
class CodeRylx extends ActiveRecord {
  ...
  @Column(name = "STRTYPE", length = 2)
  var strtype: java.lang.String = _
