...
/**
  * GafisCaseFinger generated by hall orm
  */
object GafisCaseFingerBak extends ActiveRecordInstance[GafisCaseFingerBak]

@Entity
@Table(name = "GAFIS_CASE_FINGER_BAK"
)
class GafisCaseFingerBak extends ActiveRecord {
  ...
  def this(gafisCaseFinger:GafisCaseFinger) {
    this()
    this.fingerId = gafisCaseFinger.fingerId
    this.seqNo = gafisCaseFinger.seqNo
    this.caseId = gafisCaseFinger.caseId
    this.isCorpse = gafisCaseFinger.isCorpse
    this.corpseNo = gafisCaseFinger.corpseNo
    this.remainPlace = gafisCaseFinger.remainPlace
    this.fgpGroup = gafisCaseFinger.fgpGroup
    this.fgp = gafisCaseFinger.fgp
    this.ridgeColor = gafisCaseFinger.ridgeColor
    this.pattern = gafisCaseFinger.pattern
    this.mittensBegNo = gafisCaseFinger.mittensBegNo
    this.mittensEndNo = gafisCaseFinger.mittensEndNo
    this.thanStatus = gafisCaseFinger.thanStatus
    this.isAssist = gafisCaseFinger.isAssist
    this.fingerImg = gafisCaseFinger.fingerImg
    this.fingerCpr = gafisCaseFinger.fingerCpr
    this.ltCount = gafisCaseFinger.ltCount
    this.llCount = gafisCaseFinger.llCount
    this.ltCountModMnt = gafisCaseFinger.ltCountModMnt
    this.llCountModMnt = gafisCaseFinger.llCountModMnt
    this.editCount = gafisCaseFinger.editCount
    this.ltDate = gafisCaseFinger.ltDate
    this.llDate = gafisCaseFinger.llDate
    this.ltOperator = gafisCaseFinger.ltOperator
    this.llOperator = gafisCaseFinger.llOperator
    this.ltStatus = gafisCaseFinger.ltStatus
    this.llStatus = gafisCaseFinger.llStatus
    this.creatorUnitCode = gafisCaseFinger.creatorUnitCode
    this.updatorUnitCode = gafisCaseFinger.updatorUnitCode
    this.modifiedtime = gafisCaseFinger.modifiedtime
    this.modifiedpsn = gafisCaseFinger.modifiedpsn
    this.inputtime = gafisCaseFinger.inputtime
    this.inputpsn = gafisCaseFinger.inputpsn
    this.deletag = gafisCaseFinger.deletag
    this.remark = gafisCaseFinger.remark
    this.sid = gafisCaseFinger.sid
    this.matchStatus = gafisCaseFinger.matchStatus
    this.developMethod = gafisCaseFinger.developMethod
    this.fingerCprNosqlId = gafisCaseFinger.fingerCprNosqlId
    this.fingerImgNosqlId = gafisCaseFinger.fingerImgNosqlId
    this.seq = gafisCaseFinger.seq
  }
}
