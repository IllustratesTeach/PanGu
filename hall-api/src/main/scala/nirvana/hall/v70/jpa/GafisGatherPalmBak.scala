...
/**
  ...
  */
object GafisGatherPalmBak extends ActiveRecordInstance[GafisGatherPalmBak]

@Entity
@Table(name = "GAFIS_GATHER_PALM_BAK"
)
class GafisGatherPalmBak extends ActiveRecord {
  ...
  def this(gafisGatherPalm:GafisGatherPalm) {
    this()
    this.pkId = gafisGatherPalm.pkId
    this.personId = gafisGatherPalm.personId
    this.fgp = gafisGatherPalm.fgp
    this.groupId = gafisGatherPalm.groupId
    this.lobtype = gafisGatherPalm.lobtype
    this.gatherData = gafisGatherPalm.gatherData
    this.inputpsn = gafisGatherPalm.inputpsn
    this.inputtime = gafisGatherPalm.inputtime
    this.modifiedpsn = gafisGatherPalm.modifiedpsn
    this.modifiedtime = gafisGatherPalm.modifiedtime
    this.seq = gafisGatherPalm.seq
    this.palmDataNosqlId = gafisGatherPalm.palmDataNosqlId
  }
}