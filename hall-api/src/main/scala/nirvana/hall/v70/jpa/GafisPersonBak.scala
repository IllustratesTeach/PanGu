...
/**
  * GafisPerson generated by hall orm
  */
object GafisPersonBak extends ActiveRecordInstance[GafisPersonBak]

@Entity
@Table(name = "Gafis_Person_Bak"
)
class GafisPersonBak extends ActiveRecord{
  ...
  @Column(name = "BIRTHDAYST", length = 23)
  var birthdayst: java.util.Date = _
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "BIRTHDAYED", length = 23)
  ...
  var avoirdupois: java.lang.Short = _
  @Column(name = "FOOTSIZE")
  var footsize: java.lang.Short = _
  @Column(name = "SHOELENGTH")
  var shoelength: java.lang.Short = _
  ...
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "RETURN_TIME", length = 23)
  ...
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "AUDITEDTIME", length = 23)
  ...
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "DELAY_DEADLINE", length = 23)
  ...
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "VALID_DATE", length = 23)
  var validDate: java.util.Date = _
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "ARRIVE_LOCAL_DATE", length = 23)
  var arriveLocalDate: java.util.Date = _
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "LEAVE_LOCAL_DATE", length = 23)
  ...
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "PASSPORT_VALID_DATE", length = 23)
  ...
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "VISA_DATE", length = 23)
  ...
  @Column(name = "CONTRCAPTURE_CODE", length = 1)
  var contrcaptureCode: java.lang.String = _
  ...
  @Column(name = "SMUGGLING", length = 1)
  var smuggling: java.lang.String = _
  @Column(name = "CASE_CLASSES2", length = 6)
  var caseClasses2: java.lang.String = _
  @Column(name = "CASE_CLASSES3", length = 6)
  ...
  def this(person:GafisPerson){
    this()
    this.personid = person.personid
    this.idcardno = person.idcardno
    this.name = person.name
    this.spellname = person.spellname
    this.usedname = person.usedname
    this.usedspell = person.usedspell
    this.aliasname = person.aliasname
    this.aliasspell = person.aliasspell
    this.sexCode = person.sexCode
    this.nativeplaceCode = person.nativeplaceCode
    this.nationCode = person.nationCode
    this.ifmarryCode = person.ifmarryCode
    this.toneCode = person.toneCode
    this.tone = person.tone
    this.birthdayst = person.birthdayst
    this.birthdayed = person.birthdayed
    this.birthCode = person.birthCode
    this.birthStreet = person.birthStreet
    this.birthdetail = person.birthdetail
    this.door = person.door
    this.doorStreet =  person.doorStreet
    this.doordetail =  person.doordetail
    this.address =  person.address
    this.addressStreet =  person.addressStreet
    this.addressdetail =  person.addressdetail
    this.cultureCode =  person.cultureCode
    this.sourceincomeCode =  person.sourceincomeCode
    this.faithCode =  person.faithCode
    this.haveemployment =  person.haveemployment
    this.jobCode =  person.jobCode
    this.headship =  person.headship
    this.employunit =  person.employunit
    this.employaddress =  person.employaddress
    this.otherspecialty =  person.otherspecialty
    this.specialidentityCode =  person.specialidentityCode
    this.politicsCode =  person.politicsCode
    this.istransientpop =  person.istransientpop
    this.istempregist =  person.istempregist
    this.havepermit =  person.havepermit
    this.haveresidence =  person.haveresidence
    this.isservice =  person.isservice
    this.specialgroupCode =  person.specialgroupCode
    this.haveseparation =  person.haveseparation
    this.ismigrantworker =  person.ismigrantworker
    this.nameofschool =  person.nameofschool
    this.istraining =  person.istraining
    this.havecertificate =  person.havecertificate
    this.staturest =  person.staturest
    this.avoirdupois =  person.avoirdupois
    this.footsize =  person.footsize
    this.shoelength =  person.shoelength
    this.bodilyformCode = person. bodilyformCode
    this.faceformCode = person. faceformCode
    this.iseyeglass =  person.iseyeglass
    this.shoesize =  person.shoesize
    this.bloodtypeCode =  person.bloodtypeCode
    this.gatherOrgCode =  person.gatherOrgCode
    this.ipaddress =  person.ipaddress
    this.gathererId =  person.gathererId
    this.gatherDate =  person.gatherDate
    this.gatherTypeId =  person.gatherTypeId
    this.status =  person.status
    this.isfingerrepeat =  person.isfingerrepeat
    this.fingerrepeatno =  person.fingerrepeatno
    this.taskSource =  person.taskSource
    this.receiveTime =  person.receiveTime
    this.isreturn =  person.isreturn
    this.returnTime =  person.returnTime
    this.annex =  person.annex
    this.inputpsn =  person.inputpsn
    this.inputtime =  person.inputtime
    this.modifiedpsn =  person.modifiedpsn
    this.modifiedtime =  person.modifiedtime
    this.deletag =  person.deletag
    this.schedule =  person.schedule
    this.approval =  person.approval
    this.dnaCode =  person.dnaCode
    this.gatherCategory =  person.gatherCategory
    this.personCategory =  person.personCategory
    this.auditor =  person.auditor
    this.auditedtime =  person.auditedtime
    this.isregather =  person.isregather
    this.gatherFingerMode =  person.gatherFingerMode
    this.caseName =  person.caseName
    this.caseClasses =  person.caseClasses
    this.reason =  person.reason
    this.gatherFingerNum =  person.gatherFingerNum
    this.fingerRemark =  person.fingerRemark
    this.deprtmac =  person.deprtmac
    this.gatherdepartcode =  person.gatherdepartcode
    this.gatheruserid =  person.gatheruserid
    this.gatherFingerTime =  person.gatherFingerTime
    this.isSendTl =  person.isSendTl
    this.caseBriefContents =  person.caseBriefContents
    this.pushStatus =  person.pushStatus
    this.pushDate =  person.pushDate
    this.remark =  person.remark
    this.dataSources =  person.dataSources
    this.fingershowStatus =  person.fingershowStatus
    this.cityCode =  person.cityCode
    this.delayDeadline =  person.delayDeadline
    this.fptGatherDepartCode =  person.fptGatherDepartCode
    this.fptGatherDepartName =  person.fptGatherDepartName
    this.sid =  person.sid
    this.blowCode =  person.blowCode
    this.blowStreet =  person.blowStreet
    this.blowDetail =  person.blowDetail
    this.blowLongitude =  person.blowLongitude
    this.blowLatitude =  person.blowLatitude
    this.blowEastwest =  person.blowEastwest
    this.blowNorthsouth =  person.blowNorthsouth
    this.seq =  person.seq
    this.cardid =  person.cardid
    this.recordmark =  person.recordmark
    this.recordsituation =  person.recordsituation
    this.validDate =  person.validDate
    this.arriveLocalDate =  person.arriveLocalDate
    this.leaveLocalDate =  person.leaveLocalDate
    this.dbSource =  person.dbSource
    this.dbSourceDis =  person.dbSourceDis
    this.jobDes =  person.jobDes
    this.isXjssmz =  person.isXjssmz
    this.passportNum =  person.passportNum
    this.countryCode =  person.countryCode
    this.foreignName =  person.foreignName
    this.passportValidDate =  person.passportValidDate
    this.visaPlace =  person.visaPlace
    this.passportType =  person.passportType
    this.visaDate =  person.visaDate
    this.assistLevel =  person.assistLevel
    this.assistBonus =  person.assistBonus
    this.assistPurpose =  person.assistPurpose
    this.assistRefPerson = person. assistRefPerson
    this.assistRefCase = person. assistRefCase
    this.assistValidDate =  person.assistValidDate
    this.assistExplain =  person.assistExplain
    this.assistDeptCode =  person.assistDeptCode
    this.assistDeptName =  person.assistDeptName
    this.assistDate =  person.assistDate
    this.assistContacts =  person.assistContacts
    this.assistNumber =  person.assistNumber
    this.assistApproval =  person.assistApproval
    this.assistSign =  person.assistSign
    this.gatherdepartname = person. gatherdepartname
    this.gatherusername =  person.gatherusername
    this.contrcaptureCode = person. contrcaptureCode
    this.certificatetype =  person.certificatetype
    this.certificateid =  person.certificateid
    this.smuggling =  person.smuggling
    this.caseClasses2 =  person.caseClasses2
    this.caseClasses3 =  person.caseClasses3
  }
