...
class GafisCase extends ActiveRecord {
     ...
     @Temporal(TemporalType.DATE)     @Column(name="CASE_OCCUR_DATE", length=8)
     ...
     @Temporal(TemporalType.DATE)     @Column(name="EXTRACT_DATE", length=8)
