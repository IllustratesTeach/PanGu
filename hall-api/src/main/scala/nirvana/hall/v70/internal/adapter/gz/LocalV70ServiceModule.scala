...
import nirvana.hall.v70.common.sys.UserServiceImpl
...
import nirvana.hall.v70.internal.adapter.gz.sys.DictServiceImpl
...
object LocalV70ServiceModule {
  ...
  def bind(binder: ServiceBinder): Unit = {
    ...
    binder.bind(classOf[SurveyFnoKnoConnService], classOf[SurveyFnoKnoConnServiceImpl])
    //同步
