...
import nirvana.hall.v70.internal.adapter.gz.jpa.{GafisCaseFingerMnt, GafisGatherFinger, GafisNormalqueryQueryque}
...
//    sttSimpQry.stDestDB = Array(destDB)
  ...
  def getQuery(oraSid: Long): GafisNormalqueryQueryque = {
