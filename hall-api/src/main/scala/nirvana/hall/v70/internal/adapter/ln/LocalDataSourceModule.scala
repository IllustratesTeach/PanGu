package nirvana.hall.v70.internal.adapter.ln
...
object LocalDataSourceModule {
  ...
  def buildDataSource(config: HallV70Config, hub: RegistryShutdownHub, logger: Logger): DataSource = {
    ...
    //migrator.migrate(InstallAllMigrations, "nirvana.hall.v70.internal.adapter.ln.migration", searchSubPackages = false)
  ...
  def contributeEntityManagerFactory(configuration:Configuration[String]): Unit ={
    configuration.add("nirvana.hall.v70.internal.adapter.ln.jpa")
