...
//    val list = GafisNormalqueryQueryque.select(GafisNormalqueryQueryque.keyId, GafisNormalqueryQueryque.queryType).where(GafisNormalqueryQueryque.oraSid === oraSid)
//    if(list.nonEmpty){
//      //???
//      list.toList.asInstanceOf[(String, Short, Short)]
//    }
