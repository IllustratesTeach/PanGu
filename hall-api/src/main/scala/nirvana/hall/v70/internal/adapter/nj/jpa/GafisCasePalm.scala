...
/**
  * GafisCasePalm generated by stark activerecord generator
  */
...
class GafisCasePalm extends ActiveRecord {
  ...
  @Column(name = "PALM_GROUP_NO", length = 25)
  var palmGroupNo: java.lang.String = _
