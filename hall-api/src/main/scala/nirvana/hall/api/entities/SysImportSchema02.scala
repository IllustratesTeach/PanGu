...
case class SysImportSchema02(
  ...
  def save()(implicit session: DBSession = SysImportSchema02.autoSession): SysImportSchema02 = SysImportSchema02.save(this)(session)

  def destroy()(implicit session: DBSession = SysImportSchema02.autoSession): Unit = SysImportSchema02.destroy(this)(session)

}


object SysImportSchema02 extends SQLSyntaxSupport[SysImportSchema02] {

  override val tableName = "SYS_IMPORT_SCHEMA_02"
  ...
  def apply(sis: SyntaxProvider[SysImportSchema02])(rs: WrappedResultSet): SysImportSchema02 = apply(sis.resultName)(rs)
  def apply(sis: ResultName[SysImportSchema02])(rs: WrappedResultSet): SysImportSchema02 = new SysImportSchema02(
 ...
 override def autoSession = nirvana.hall.api.services.AutoSpringDataSourceSession()
  ...
  def create(
    ...
    clusterOk: Option[Long] = None,
    serviceName: Option[String] = None,
    objectIntOid: Option[String] = None)(implicit session: DBSession = autoSession): SysImportSchema02 = {
    withSQL {
      insert.into(SysImportSchema02).columns(
        column.processOrder,
        column.duplicate,
        column.dumpFileid,
        column.dumpPosition,
  ...
  def save(entity: SysImportSchema02)(implicit session: DBSession = autoSession): SysImportSchema02 = {
    withSQL {
      update(SysImportSchema02).set(
