...
case class Et$014e0fc20001(
  ...
  def save()(implicit session: DBSession = Et$014e0fc20001.autoSession): Et$014e0fc20001 = Et$014e0fc20001.save(this)(session)

  def destroy()(implicit session: DBSession = Et$014e0fc20001.autoSession): Unit = Et$014e0fc20001.destroy(this)(session)

}


object Et$014e0fc20001 extends SQLSyntaxSupport[Et$014e0fc20001] {

  override val tableName = "ET$014E0FC20001"
  ...
  def apply(e: SyntaxProvider[Et$014e0fc20001])(rs: WrappedResultSet): Et$014e0fc20001 = apply(e.resultName)(rs)
  def apply(e: ResultName[Et$014e0fc20001])(rs: WrappedResultSet): Et$014e0fc20001 = new Et$014e0fc20001(
    pkId = rs.get(e.pkId),
  ...
  val e = Et$014e0fc20001.syntax("e")

 override def autoSession = nirvana.hall.api.services.AutoSpringDataSourceSession()

  def find(pkId: Option[String], personId: Option[String], fgp: Option[Short], groupId: Option[Short], lobtype: Option[Short], inputpsn: Option[String], inputtime: Option[DateTime], modifiedpsn: Option[String], modifiedtime: Option[DateTime], fgpCase: Option[String], auditStatus: Option[Short], description: Option[String], mainPattern: Option[Short], vicePattern: Option[Short], seq: Option[Long], fingerDataNosqlId: Option[String], gatherData: Option[Blob])(implicit session: DBSession = autoSession): Option[Et$014e0fc20001] = {
    withSQL {
      select.from(Et$014e0fc20001 as e).where.eq(e.pkId, pkId).and.eq(e.personId, personId).and.eq(e.fgp, fgp).and.eq(e.groupId, groupId).and.eq(e.lobtype, lobtype).and.eq(e.inputpsn, inputpsn).and.eq(e.inputtime, inputtime).and.eq(e.modifiedpsn, modifiedpsn).and.eq(e.modifiedtime, modifiedtime).and.eq(e.fgpCase, fgpCase).and.eq(e.auditStatus, auditStatus).and.eq(e.description, description).and.eq(e.mainPattern, mainPattern).and.eq(e.vicePattern, vicePattern).and.eq(e.seq, seq).and.eq(e.fingerDataNosqlId, fingerDataNosqlId).and.eq(e.gatherData, gatherData)
    }.map(Et$014e0fc20001(e.resultName)).single.apply()
  }

  def findAll()(implicit session: DBSession = autoSession): List[Et$014e0fc20001] = {
    withSQL(select.from(Et$014e0fc20001 as e)).map(Et$014e0fc20001(e.resultName)).list.apply()
  }

  def countAll()(implicit session: DBSession = autoSession): Long = {
    withSQL(select(sqls.count).from(Et$014e0fc20001 as e)).map(rs => rs.long(1)).single.apply().get
  }

  def findBy(where: SQLSyntax)(implicit session: DBSession = autoSession): Option[Et$014e0fc20001] = {
    withSQL {
      select.from(Et$014e0fc20001 as e).where.append(where)
    }.map(Et$014e0fc20001(e.resultName)).single.apply()
  }

  def findAllBy(where: SQLSyntax)(implicit session: DBSession = autoSession): List[Et$014e0fc20001] = {
    withSQL {
      select.from(Et$014e0fc20001 as e).where.append(where)
    }.map(Et$014e0fc20001(e.resultName)).list.apply()
  }

  def countBy(where: SQLSyntax)(implicit session: DBSession = autoSession): Long = {
    withSQL {
      select(sqls.count).from(Et$014e0fc20001 as e).where.append(where)
  ...
  def create(
    ...
    seq: Option[Long] = None,
    fingerDataNosqlId: Option[String] = None,
    gatherData: Option[Blob] = None)(implicit session: DBSession = autoSession): Et$014e0fc20001 = {
    withSQL {
      insert.into(Et$014e0fc20001).columns(
        column.pkId,
        column.personId,
        column.fgp,
        column.groupId,
  ...
  def save(entity: Et$014e0fc20001)(implicit session: DBSession = autoSession): Et$014e0fc20001 = {
    withSQL {
      update(Et$014e0fc20001).set(
