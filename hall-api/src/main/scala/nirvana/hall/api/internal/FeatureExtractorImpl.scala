...
import nirvana.hall.api.jni.NativeExtractor
import nirvana.hall.api.services.FeatureExtractor
...
import nirvana.hall.support.services.{GAFISImageReaderSpi, HallExtractorConstants}
