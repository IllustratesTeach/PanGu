...
class GafisGatherOcxVersion extends ActiveRecord {
    ...
    def this(pkId:java.lang.String, name:java.lang.String, type:java.lang.String, remark:java.lang.String, createDatetime:java.util.Date, deletag:java.lang.String) {
       this()
       this.pkId = pkId
       this.name = name
       this.type = type
