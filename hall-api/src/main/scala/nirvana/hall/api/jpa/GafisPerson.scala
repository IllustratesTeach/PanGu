...
class GafisPerson extends ActiveRecord {
     ...
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="BIRTHDAYST", length=23)
     var birthdayst:java.util.Date =  _
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="BIRTHDAYED", length=23)
     ...
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="RECEIVE_TIME", length=23)
     var receiveTime:java.util.Date =  _
          @Column(name="ISRETURN", length=1)
     var isreturn:java.lang.String =  _
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="RETURN_TIME", length=23)
     ...
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="AUDITEDTIME", length=23)
     ...
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="GATHER_FINGER_TIME", length=23)
     ...
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="PUSH_DATE", length=23)
     ...
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="DELAY_DEADLINE", length=23)
     ...
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="VALID_DATE", length=23)
     var validDate:java.util.Date =  _
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="ARRIVE_LOCAL_DATE", length=23)
     var arriveLocalDate:java.util.Date =  _
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="LEAVE_LOCAL_DATE", length=23)
     ...
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="PASSPORT_VALID_DATE", length=23)
     ...
     @Temporal(TemporalType.TIMESTAMP)     @Column(name="VISA_DATE", length=23)
