...
licensing requirements; and it is considered public domain.聽 Therefore,
...
extern int wsq_decodedinfo(int *, int *, int *, unsigned char *, const int);
extern int wsq_decode_file(unsigned char **, int *, int *, int *, int *,
                 int *, FILE *);
extern int huffman_decode_data_mem(short *, DTT_TABLE *, DQT_TABLE *,
                 DHT_TABLE *, unsigned char **, unsigned char *, FRM_HEADER_WSQ *, Q_TREE *);
...
//!< 考虑到多线程，增加几个函数，以去掉getc_nextbits_wsq、nextbits_wsq中的局部静态变量
extern int decode_data_mem_ex(int *, int *, int *, int *, unsigned char *,
						   unsigned char **, unsigned char *, int *, unsigned short *, unsigned char *);
extern int decode_data_file_ex(int *, int *, int *, int *, unsigned char *, FILE *,
							int *, unsigned short *, unsigned char *);
extern int nextbits_wsq_ex(unsigned short *, unsigned short *, FILE *, int *,
						const int, unsigned char *);
extern int getc_nextbits_wsq_ex(unsigned short *, unsigned short *,
							 unsigned char **, unsigned char *, int *, const int, unsigned char *);
...
extern void init_wsq_decoder_resources(DTT_TABLE *pdtt_table);
