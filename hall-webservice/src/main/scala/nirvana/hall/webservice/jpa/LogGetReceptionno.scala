...
class LogGetReceptionno extends ActiveRecord {
    ...
    def this(pkId:java.lang.String, username:java.lang.String, xckybh:java.lang.String, calltime:java.util.Date, returnJjbh:java.lang.String, returntime:java.util.Date, errormsg:java.sql.Clob) {
       this()
       this.pkId = pkId
