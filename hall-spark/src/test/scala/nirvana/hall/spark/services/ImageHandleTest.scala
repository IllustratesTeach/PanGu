...
class ImageHandleTest {
  ...
  @Test
  def handle() : Unit = {
    val jpg = new FileInputStream("C:\\Users\\wangjue\\Desktop\\ImageHandle\\image.jpg")
    val image = ImageIO.read(jpg)

    val outImage = new FileOutputStream("D:\\img.img")
    ...
    ImageIO.write(tempImage,"jpg",tempByteArray)
